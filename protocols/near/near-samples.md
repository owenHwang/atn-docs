---
description: NEAR nodes accept HTTP requests using the JSON-RPC 2.0 specification.
---
...
```shell
curl https://near-mainnet-rpc.allthatnode.com:3030/'YOUR-API-KEY' \
--request POST \
--header "Content-Type: application/json" \
--data '{"jsonrpc": "2.0","method": "block","params": {"finality": "final"},"id": "dontcare"}'
```
